        ...
        return (
            <div>
                ...
                <form className="form-horizontal" onSubmit={this.handleSubmit} >
                    ...
                    <div className="form-group">
                        <div className="col-sm-12">
                            <input type="text" className="form-control" placeholder="Address 2" value={this.state.address2} onChange={(e) => this.handleChange('address2', e)} />
                        </div>
                    </div>
                    <div className="form-group">
                        <div className="col-sm-12">
                    ...
                    <div className="form-group">
                        <div className="col-sm-12">
                            <input type="text" className="form-control" placeholder="State" value={this.state.states} onChange={(e) => this.handleChange('states', e)} />
                        </div>
                    </div>
                    <div className="form-group">
                        <div className="col-sm-12">
                            <input type="text" className="form-control" placeholder="Zipcode" value={this.state.zip} onChange={(e) => this.handleChange('zip', e)} />
                        </div>
                    </div>
                    <div className="form-group">
                        <div className="col-sm-12">
